import { VERSION } from './config.js?v=2.4.0';
export function buildReport(game, settings, errors = []) {
  return JSON.stringify({ game: 'Stick & Swing', version: VERSION, seed: game.initialSeed, randomState: game.seed,
    ...
    weapon: game.weapon, forms: game.forms, keepsake: game.keepsake, decisions: game.decisions, gifts: game.upgrades, health: game.player.hp, ink: game.ink,
