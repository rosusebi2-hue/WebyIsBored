import { VERSION } from './config.js?v=2.2.0';
export function buildReport(game, settings, errors = []) {
  return JSON.stringify({ game: 'Stick & Swing', version: VERSION, seed: game.initialSeed, randomState: game.seed,
    ...
    weapon: game.weapon, forms: game.forms, gifts: game.upgrades, health: game.player.hp, ink: game.ink,
    stats: game.stats, lastHit: game.lastHit || null, events: game.eventsSeen,
    ...
    effects: { sound: settings.sound, reduced: settings.reduced }, errors: errors.slice(-5),
